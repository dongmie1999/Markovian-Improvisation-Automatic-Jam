...
def hmmmelody():
    startprob = np.array([0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.10, 0.00, 0.00])
    transmat = np.array([[0.05, 0.10, 0.20, 0.15, 0.20, 0.10, 0.05, 0.05, 0.10],
                         [0.10, 0.05, 0.10, 0.20, 0.20, 0.10, 0.10, 0.05, 0.10],
                         [0.20, 0.10, 0.05, 0.10, 0.10, 0.20, 0.10, 0.05, 0.10],
                         [0.10, 0.10, 0.20, 0.05, 0.10, 0.10, 0.20, 0.05, 0.10],
                         [0.10, 0.20, 0.10, 0.10, 0.05, 0.10, 0.20, 0.05, 0.10],
                         [0.05, 0.10, 0.20, 0.25, 0.10, 0.05, 0.10, 0.05, 0.10],
                         [0.05, 0.10, 0.20, 0.10, 0.25, 0.10, 0.05, 0.05, 0.10],
                         [0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.16, 0.00],
                         [0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.16, 0.00]])
