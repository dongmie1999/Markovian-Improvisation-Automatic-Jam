...
class Mother_Ocean():
    ...
    def chorus(self, num):
        ...
        if num == 1:
            track.add_note(5, 0.6, channel=1, velocity=1.2, pitch_type=2,
                           bend_setting={'pitch': 6000, 'PASDA': [0.1, 0.6, 2, 0.5, 0.3]})
            track.add_note(5, 1.9, channel=1, pitch_type=1, tremble_setting={'pitch': 1000, 'wheel_times': 6})  # 海
        if num == 2:
            track.add_note(5, 0.65, channel=1, velocity=1.2, pitch_type=2,
                           bend_setting={'pitch': 6000, 'PASDA': [0.1, 0.9, 2, 0.9, 0.3]})
    ...
    def tom_and_snare_pt1(self):
        ...
        # track.add_drum('acoustic_snare', 0.25, velocity=0.8)
        for i in range(20):
            track.add_drum('acoustic_snare', 1, velocity=0.8)
    ...
    def my_chorus(self):
        ...
        for i in range(6):
            track.my_chorus_3_simple(chord_progression=['Fmaj7', 'Em7', 'Dm7', 'Cmaj7'], type=i+1)

    def write_song(self):

        # self.mid.add_new_track('Piano', self.time_signature, self.bpm, self.key, {'0': 0})
...
def piano_roll_test():
    ...
    mid.generate_track_from_numpy_matrix("../data/numpy/mother_ocean/chord.npy", (288, 128), 'Chord', False, True,
                                         '../data/plots/mother_ocean/chord.png')

    mid.turn_track_into_numpy_matrix('Hi-Hat', "../data/numpy/mother_ocean/hi-hat.npy")
    mid.generate_track_from_numpy_matrix("../data/numpy/mother_ocean/hi-hat.npy", (288, 128), 'Hi-Hat', True, True,
                                         '../data/plots/mother_ocean/hi-hat.png')

    mid.turn_track_into_numpy_matrix('Tom And Snare', "../data/numpy/mother_ocean/tom_and_snare.npy")
    mid.generate_track_from_numpy_matrix("../data/numpy/mother_ocean/tom_and_snare.npy", (288, 128), 'Tom And Snare',
                                         True, True, '../data/plots/mother_ocean/tom_and_snare.png')
